...
const App = () => {
    ...
    try {
      async function blueTooth() {
        const permissions = {
          ...
          message: 'HSD Bluetooth requires access to Bluetooth to connect to the Bluetooth printer',
          buttonNeutral: 'Later',
          buttonNegative: 'No',
  ...
  return (
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.sectionTitle}>Printers connected to the application:</Text>
        ...
        {boundAddress.length < 1 && (
          <Text style={styles.printerInfo}>No printers connected</Text>
        )}
        <Text style={styles.sectionTitle}>Bluetooth devices connected to this phone:</Text>
